...
ui <- fluidPage(
  sidebarLayout(
    sidebarPanel(
      fluidRow(
        column(6, checkboxInput("grad", "gradient")),
        column(6, checkboxInput("iter", "iterations"))
      ),
      fluidRow(
        column(6, checkboxInput("drawAda", "Adaline", FALSE)),
        column(6, checkboxInput("drawHeb", "Kheb", FALSE))
      ),
      fluidRow(
